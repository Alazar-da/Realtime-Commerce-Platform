// app/dashboard/sub-categories/components/SubCategoryModal.tsx
"use client";
...
export function SubCategoryModal({
  ...
  const validateSlug = async (slugToCheck: string) => {
    ...
    try {
      const result = await SubCategoryService.validateSlug(
        slugToCheck,
        initialData?.id
      );
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await onSubmit(data);
      toast.success(initialData ? 'Sub-category updated successfully' : 'Sub-category created successfully');
      resetForm();
      onClose();
    } catch (error) {
